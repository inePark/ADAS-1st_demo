...
//                    result_ = assignDB_FRONT ();
    ...
    private int assignDB_RIGHT_LEANED ()	{
        ...
        double [][][] db_sample  = {
                { //right
                        {0.502, 0.528, 0.561, 0.568, 0.619, 0.663, 0.657, 0.607, 0.552, 0.547, 0.489, 0.437, 0.354, 0.324, 0.341, 0.388, 0.46, 0.485, 0.483, 0.457, 0.534, 0.637, 0.653},
                        {0.036, 0.022, -0.004, -0.016, -0.049, -0.071, -0.091, -0.09, -0.068, -0.048, -0.031, -0.035, -0.037, -0.036, -0.083, -0.131, -0.145, -0.11, -0.068, -0.062, -0.045, -0.035, 0.002},
                        {-0.098, -0.126, -0.21, -0.266, -0.407, -0.492, -0.576, -0.575, -0.536, -0.498, -0.395, -0.33, -0.171, -0.077, 0.079, 0.142, 0.269, 0.334, 0.452, 0.506, 0.533, 0.506, 0.448}
                },
                {
                        {0.464, 0.464, 0.447, 0.429, 0.435, 0.459, 0.499, 0.516, 0.509, 0.486, 0.455, 0.447, 0.426, 0.412, 0.428, 0.459, 0.518, 0.546, 0.547, 0.52, 0.527, 0.561, 0.605},
                        {0.074, 0.084, 0.135, 0.175, 0.241, 0.266, 0.305, 0.319, 0.227, 0.122, -0.102, -0.221, -0.393, -0.446, -0.489, -0.479, -0.511, -0.554, -0.528, -0.459, -0.41, -0.43, -0.448},
                        {0.014, 0.036, 0.122, 0.186, 0.342, 0.435, 0.636, 0.744, 0.8, 0.748, 0.589, 0.482, 0.287, 0.2, 0.044, -0.023, -0.203, -0.314, -0.456, -0.486, -0.569, -0.622, -0.628}
                }
        };
        double [][] db_average = {
                {0.5150, -0.0520 -0.0647},
                {0.4852, -0.1531, 0.1028}
        };

        double [][] db_cov  = {
                {0.010326, 0.002021, 0.152776},
                {0.002603, 0.109294, 0.212035}
    ...
    private static final int GAP_THRESHOLD = 600;
